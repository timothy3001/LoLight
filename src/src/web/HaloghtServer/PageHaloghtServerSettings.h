      ...
      <div class="col-sm-8">
        <form class="form-horizontal" action="javascript:void(0);">
          <div class="form-group">
            <label class="control-label" for="defaultColorInput">Default color</label>
            <input type="color" class="form-control" id="defaultColorInput" name="defaultColorInput"
              style="height: 50px;" />
          </div>
          <div class="form-group">
            ...
            <div class="row">
              <div class="col-4 my-auto pr-0">
                <label for="hostnameSuffixInput" class="float-right" style="padding-right: 0px;">Haloght -&nbsp;</label>
              </div>
              <div class="col-8 pl-0">
                <input type="text" class="form-control float-left" id="hostnameSuffixInput" name="hostnameSuffixInput"
                  placeholder="Suffix..." />
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-6">
                <button class="btn btn-danger float-right" id="resetButton">Reset</button>
              </div>
            </div>
          </div>
      </div>
